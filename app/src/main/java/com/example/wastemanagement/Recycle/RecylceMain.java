package com.example.wastemanagement.Recycle;
...
public class RecylceMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recylce_main);

        viewPager2 = findViewById(R.id.viewpager);
        int[] images = {R.drawable.a,R.drawable.b,R.drawable.c,R.drawable.d,R.drawable.e};
        String[] heading = {"Batteries","Electronic","Glass","Paper","Organic Waste"};
