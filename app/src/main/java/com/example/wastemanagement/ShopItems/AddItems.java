...
public class AddItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awarenessiImageRef = FirebaseStorage.getInstance().getReference().child("Item Images");
        ...
        arrowBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddItems.this, AdminDashboard_1.class);
        ...
        databaseReference.child(RandomKey).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    finish();
                    loadingBar.dismiss();
                    Toast.makeText(AddItems.this, "Item has been added", Toast.LENGTH_SHORT).show();
                }else{
                    loadingBar.dismiss();
