...
public class AwarenesssUsers {
    ...
    public AwarenesssUsers(){}

    public AwarenesssUsers(String status, String lid, String date, String time, String image, String title, String header, String description, String houseLocation, String houseContactNumber, String houseOwner, String userId, String search) {
        this.status = status;
        this.lid = lid;
        this.date = date;
        this.time = time;
