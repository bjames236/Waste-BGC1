...
import com.example.wastemanagement.Admin.AdminUsers;
...
public class CallActivityShop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_call_shop);

        ImageButton arrowBack = (ImageButton) findViewById(R.id.arrowback_myAwareness);
        arrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent (CallActivityShop.this, AdminDashboard_1.class);
        ...
        startBTN.setOnClickListener((v)->{
            ...
            //start the service
            startService(userID);
            Toast.makeText(CallActivityShop.this, "The service has started. Press only once.", Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                assert users != null;
                heyUserTextView.setText(users.getFullname());
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CallActivityShop.this,"Error, please report this bug!", Toast.LENGTH_SHORT).show();
            }
        });
