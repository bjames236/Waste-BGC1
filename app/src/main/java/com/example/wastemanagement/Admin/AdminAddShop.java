...
import com.example.wastemanagement.Call.CallMainShop;
...
public class AdminAddShop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBTN = (Button) findViewById(R.id.addBoarding);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AdminAddShop.this,"Error, please report this bug!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void storeToDatabase() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AdminAddShop.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
    ...
    private void SaveInfoToDatabase() {
        ...
        databaseReference.child(RandomKey).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Intent intent = new Intent(AdminAddShop.this, AdminLogin.class);
                    startActivity(intent);
                    finish();
                    loadingBar.dismiss();
                    Toast.makeText(AdminAddShop.this, "Shop has been added", Toast.LENGTH_SHORT).show();
                }else{
                    loadingBar.dismiss();
