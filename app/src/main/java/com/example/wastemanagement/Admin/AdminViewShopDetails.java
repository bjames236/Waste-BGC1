...
public class AdminViewShopDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_shop_details);

        ImageButton arrowBack = (ImageButton) findViewById(R.id.Adminarrowback_Details);
        arrowBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AdminViewShopDetails.this, AdminViewShop.class);
