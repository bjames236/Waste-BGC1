    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrowBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AdminChangePassword.this, AdminDashboard_1.class);
        ...
        changePass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(oldPass.isEmpty() || newPass.isEmpty() || confirmNewPass.isEmpty()){
                    Toast.makeText(AdminChangePassword.this, "Please fill all the fields", Toast.LENGTH_SHORT).show();
                }else if (newPass.isEmpty()){
                    newPasswordSecurity.setError("Enter your new password");
                    Toast.makeText(AdminChangePassword.this, "Enter your new password", Toast.LENGTH_SHORT).show();
                }else if (! confirmNewPass.equals(newPass)){
                    confirmNewPasswordSecurity.setError("Password does not match");
                    Toast.makeText(AdminChangePassword.this, "Password does not match", Toast.LENGTH_SHORT).show();
                }else{
                            ...
                            if (task.isSuccessful()){
                                ...
                                databaseReference.child(User.getUid()).updateChildren(Users).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        loadBar.dismiss();
                                        Toast.makeText(AdminChangePassword.this, "Changed Password Successfully, Please Login Again!", Toast.LENGTH_SHORT).show();
                                        Auth.signOut();
                                ...
                                loadBar.dismiss();
                                Toast.makeText(AdminChangePassword.this, "Password should be atleast 6 characters", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }else{
                    loadBar.dismiss();
                    Toast.makeText(AdminChangePassword.this, "Incorrect Old Password!", Toast.LENGTH_SHORT).show();
                }
